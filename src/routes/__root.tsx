...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PainPoint — Doctor Anywhere" },
      {
        name: "description",
        content:
          "Dual-dashboard pain tracking for elderly Malaysian patients and their caregivers.",
      },
      { name: "author", content: "PainPoint" },
      { property: "og:title", content: "PainPoint" },
      {
        property: "og:description",
        content: "Discover · Book · Follow Up — chronic care for Malaysian families.",
      },
